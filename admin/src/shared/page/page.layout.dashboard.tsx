...
import { navbarDefaultConfiguration } from 'shared/navbar/navbar.configuration'
import { useSelector } from 'react-redux'
import { selectDrawerStatus } from 'modules/app/app.redux'
import { defaultDrawerMenu } from 'shared/drawer/drawer.menu.config'
...
const DashboardLayout = ({ title, titleIcon: TitleIcon, children }: Props) => {
